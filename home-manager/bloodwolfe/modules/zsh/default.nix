...
let
  starshipConfig = config.dotfiles.source "zsh/starship.toml" ./starship.toml;
in
{
  programs.zsh = {
    enable = true;
  ...
  home = {
    ...
    sessionVariables.STARSHIP_CONFIG = toString starshipConfig;
    file.".config/starship.toml".source = starshipConfig;
  };
}
