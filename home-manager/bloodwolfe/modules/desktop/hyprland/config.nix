  ...
  wayland.windowManager.hyprland.extraConfig =
    ...
    lib.mkBefore ''
      ...
      submap = REPOSITION
        ...
        binde = , l, exec, ${hl-util} activewindow mv r
        binde = , j, exec, ${hl-util} activewindow mv d
        binde = , k, exec, ${hl-util} activewindow mv u
        binde = , h, exec, ${hl-util} activewindow mv l
      submap = escape

      submap = SWAPWINDOW
        ${const}      
        bindi = , p, submap, REPOSITION 
        binde = , l, exec, ${hl-util} activewindow swap r
        binde = , j, exec, ${hl-util} activewindow swap d
        binde = , k, exec, ${hl-util} activewindow swap u
        binde = , h, exec, ${hl-util} activewindow swap l
      submap = escape
      ...
      submap = UTILITY
        ${const}
        bindi = , f, exec, ${pkgs.hyprfreeze} -a -s
